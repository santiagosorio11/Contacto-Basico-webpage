<?php
// --- CONFIGURACIÓN ---
// El usuario deberá reemplazar estos valores con los suyos.
$servername = "localhost";
$username = "tu_usuario_de_bd";
$password = "tu_contraseña_de_bd";
$dbname = "tu_nombre_de_bd";
$destinatario = "tu-correo@tudominio.com";
...
// --- PREPARACIÓN Y ENVÍO DEL CORREO (PRIORIDAD #1) ---
...
if (mail($destinatario, $asunto, $cuerpo_mensaje, $headers)) {
    // Si el correo se envió con éxito, ahora guardamos una copia en la base de datos.
    try {
